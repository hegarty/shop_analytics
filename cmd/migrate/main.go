// Command migrate applies or rolls back shop_analytics's schema
// migrations. Never run against production from a local machine.
package main
...
import (
	...
	"github.com/hegarty/shop_analytics/migrations"
)
